...
class JsonParserTest {
    ...
    fun `parse object with an array (Account) works`() {
        ...
        val account = JsonParserDynamicAndUnsafe.parse(json, Account::class) as Account
    ...
    fun `parse object with an array (Competition) works`() {
        ...
        val competition = JsonParserDynamicAndUnsafe.parse(json, Competition::class) as Competition
    ...
    fun `Parse object with other property name (Employee) works`() {
        ...
        val employee = JsonParserDynamicAndUnsafe.parse(json, Employee::class) as Employee
    ...
    fun `Parse object with param that is not a property throws ParseException`() {
        ...
        assertFailsWith<ParseException> {
            JsonParserDynamicAndUnsafe.parse(json, Car::class) as Car
        }
    }
}
